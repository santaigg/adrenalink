      ...
      <div className="flex flex-row">
        <div className="flex-1">
          <input
            ...
            onBlur={toggleFocus}
            className={cn(
              "h-9 w-full bg-input px-3 py-1 outline-none placeholder:text-input-foreground border border-input focus-visible:border-accent disabled:cursor-not-allowed disabled:opacity-50",
              className
            )}
            ref={ref}
            {...props}
